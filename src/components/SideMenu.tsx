...
export function SideMenu() {
    return (
        <>
            <aside className="sidebar w-52 flex flex-col items-center p-3 text-black">
                ...
                <nav className="menu w-full flex flex-col items-start space-y-4 gap-8">
                    <div
                        className="menu-item group w-full p-2 flex items-center cursor-pointer transition duration-300 hover:bg-green-400 rounded-full">
                        <Link to="/dashboard" className="flex items-center space-x-4">
                            <div className="icon flex justify-center items-center">
                                <img src={dashboardIcon} alt="Home" className="custom-icon"/>
                            </div>
                            <span
                                className="menu-name opacity-1000 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Dashboard</span>
                        </Link>
                    </div>
                    ...
                    <div
                        ...
                        <Link to="/field" className="flex items-center space-x-4">
                            ...
                            <span
                                className="menu-name opacity-100 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Field</span>
                        </Link>
                    </div>
                    ...
                    <div
                        ...
                        <Link to="/staff" className="flex items-center space-x-4">
                            ...
                            <span
                                className="menu-name opacity-100 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Staff</span>
                        </Link>
                    </div>
                    ...
                    <div
                        ...
                        <Link to="/vehicle" className="flex items-center space-x-4">
                            ...
                            <span
                                className="menu-name opacity-100 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Vehicle</span>
                        </Link>
                    </div>
                    ...
                    <div
                        ...
                        <Link to="/equipment" className="flex items-center space-x-4">
                            ...
                            <span
                                className="menu-name opacity-100 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Equipment</span>
                        </Link>
                    </div>
                    ...
                    <div
                        ...
                        <Link to="/crop" className="flex items-center space-x-4">
                            ...
                            <span
                                className="menu-name opacity-100 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Crop</span>
                        </Link>
                    </div>
                    ...
                    <div
                        ...
                        <Link to="/cropdetails" className="flex items-center space-x-4">
                            ...
                            <span
                                className="menu-name opacity-100 group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 text-gray-800 font-bold text-lg">Crop Details</span>
                        </Link>
                    </div>
                </nav>
            </aside>
